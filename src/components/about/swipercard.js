...
const SwiperCard = ({ item }) => {
  return (
    <div className="w-full h-full lg:h-[30rem] flex flex-col lg:flex-row gap-[2rem] lg:gap-[3rem] px-[1.5rem] py-[1rem] lg:p-[3rem] bg-[linear-gradient(to_bottom,#FFF,#F1F3F6))]">
      <div>
        <Image
          src={item?.icon}
          height={120}
