  ...
  return (
    <div className="px-[1.25rem] pb-[4rem] lg:px-[12.5rem] lg:pb-[8rem] grid grid-cols-1 lg:grid-cols-2 lg:gap-[0.125rem]">
      {points?.map((item, index) => (
        <div
          key={index}
          className="flex flex-col gap-[1rem] lg:gap-[2rem] px-[1rem] py-[1.5rem] lg:p-[3rem] bg-[linear-gradient(to_bottom,#FFF,#F1F3F6))] hover:bg-[linear-gradient(to_top,#FFF,#F1F3F6))]"
        >
          <div>
            <Image
              src={item?.icon}
